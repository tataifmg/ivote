    ...
    <form method="post" action="{{ route('update-p', $proposta->id) }}">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">  
          ...
          <input type="date" class="form-control" id="data-in-adm" name="data-in-adm" value="{{$proposta->data_inicio_votacao_decisor->format('Y-m-d')}}">
        </div>
          
        <div class="form-group col-md-4">
          <label for="data-fim-adm">Data do fim da votação do decisor :</label>
          <input type="date" class="form-control" id="data-fim-com" name="data-fim-adm" value="{{$proposta->data_fim_votacao_decisor->format('Y-m-d')}}">
        </div>  
      </div>
      <div class="row">
        <div class="form-group col-md-4">
        ...
        <!--  Conferir se esse atributo pode ser mudado 
        <div class="form-group col-md-4">        
          <label for="chave-acesso">Chave de acesso :</label>        
          <input type="text" class="form-control" id="chave-acesso" name="chave-acesso" >        
        </div>      
        -->
      </div> 
